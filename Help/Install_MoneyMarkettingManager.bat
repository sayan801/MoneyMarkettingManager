...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "MoneyMarkettingManager" /productName "MoneyMarkettingManager" > NUL
...
COPY /Y "MoneyMarkettingManager.msha" HelpContentSetup.msha
